...
- [x] **Web Dashboard (`docs/`):**
  ...
  - Dynamic champion selector (Lucian, Smolder, Ekko Jungla/Mid, Gwen Jungla/Mid, Volibear Jungla, Annie Mid, Warwick Top/Jungla, Fiddlesticks Jungla) con barra de selección de línea por icono oficial.
